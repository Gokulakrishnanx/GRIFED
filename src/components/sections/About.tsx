    ...
    <section id="about" className="py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-blue-500 font-semibold tracking-wide uppercase">About Us</h2>
...
const features = [
  {
    ...
    description: 'We stay ahead of the curve by implementing cutting-edge technologies and methodologies.',
    icon: (
  ...
  },
  {
    ...
    description: 'We maintain high standards in everything we do, ensuring reliable and scalable solutions.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
